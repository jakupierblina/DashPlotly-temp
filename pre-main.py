...
df = pd.read_csv("https://raw.githubusercontent.com/jakupierblina/expert_data_dashboard/main/data/country_internet_cleanded.csv")
df = df[df['year'] == 2019]
...
app.layout = html.Div([
        # title head row
        dbc.Row(dbc.Col(html.H1('DashBoot Data webapp', style={'textAlign': 'center'}),)),
        #second row
        dbc.Row([
            #column 1 side menu
            dbc.Col(
                ...
                dbc.NavLink("Positions", href="/page-1", active="exact"),
                dbc.NavLink("Analysis", href="/page-2", active="exact"),
                dbc.NavLink("New", href="/page-3", active="exact"),],
                # after
            vertical=True,
            pills=True,
            ), ),
